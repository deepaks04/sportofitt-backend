...
Route::group(['prefix' => 'api/v1/vendor/'], function () {
    ...
    Route::post('facility/upload', array('uses' => 'Vendor\VendorsController@addFacilityImages'));
    Route::get('getimages/{id}', array('uses' => 'Vendor\VendorsController@getImages'));
    ...
    Route::get('package/{id}', array('uses' => 'Vendor\SessionPackageContr oller@getPackage'));
    ...
    Route::get('get-calendar-block/{date}/{sort}/{facilityId}', array('uses' => 'Vendor\SessionPackageController@getBlockData'));
