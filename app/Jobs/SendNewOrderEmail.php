    ...
    public function handle()
    {
        try {
            ...
            $order = Order::select('orders.order_id As orderNumber', 'orders.order_total', 'orders.payment_mode', 'users.fname', 'users.lname',
                    ...
                    'booked_packages.id AS bookingId', 'booked_timings.booking_date', 'booked_timings.start_time', 
            ...
            if ($order) {
                ...
                $facilityDetails = \App\AvailableFacility::select('available_facilities.is_venue', 'available_facilities.is_venue',
                        'vendors.business_name', 'vendors.contact', 'areas.name AS AreaName', 'sub_categories.name AS subCategoryName',
                        'vendors.postcode','vendors.address')
                ...
                $params['totalAmount'] = ($params['bookingAmount'] + $params['convenienceCharges'] + $params['discountAmount']);
